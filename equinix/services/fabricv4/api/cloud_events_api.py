...
class CloudEventsApi:
    ...
    @validate_call
    def search_last_op_events(
        self,
        operational_event_search_request: OperationalEventSearchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param operational_event_search_request: (required)
        :type operational_event_search_request: OperationalEventSearchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._search_last_op_events_serialize(
            operational_event_search_request=operational_event_search_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SearchOperationalEventResponse",
            '401': "List[Error]",
            '403': "List[Error]",
            '404': "List[Error]",
            '500': "List[Error]",
    ...
    @validate_call
    def search_last_op_events_with_http_info(
        self,
        operational_event_search_request: OperationalEventSearchRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SearchOperationalEventResponse]:
        """Search Last Operational Cloud Events
    ...
    @validate_call
    def search_last_op_events_without_preload_content(
        self,
        operational_event_search_request: OperationalEventSearchRequest,
        _request_timeout: Union[
            None,
    ...
    def _search_last_op_events_serialize(
        self,
        operational_event_search_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if operational_event_search_request is not None:
            _body_params = operational_event_search_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/fabric/v4/latestOperationalEvents/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
