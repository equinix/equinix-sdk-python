...
class DeploymentsApi:
    ...
    def action_deployment(
        ...
        :param deployment_action_request: (required)
        :type deployment_action_request: DeploymentActionRequest
        ...
        _param = self._action_deployment_serialize(
            deployment_id=deployment_id,
            deployment_action_request=deployment_action_request,
    ...
    def _action_deployment_serialize(
        self,
        deployment_id,
        deployment_action_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if deployment_action_request is not None:
            _body_params = deployment_action_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/fabric/v4/deployments/{deploymentId}/actions',
    ...
    @validate_call
    def create_topology_deployment(
        self,
        ...
        _param = self._create_topology_deployment_serialize(
            deployment=deployment,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def create_topology_deployment_with_http_info(
        self,
        deployment: Deployment,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_topology_deployment_without_preload_content(
        self,
        deployment: Deployment,
        _request_timeout: Union[
            None,
    ...
    def _create_topology_deployment_serialize(
        self,
        deployment,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/fabric/v4/deployments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_deployment_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/fabric/v4/deployments/{deploymentId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def search_deployments(
        self,
        deployment_search_request: DeploymentSearchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param deployment_search_request: (required)
        :type deployment_search_request: DeploymentSearchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._search_deployments_serialize(
            deployment_search_request=deployment_search_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def search_deployments_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeploymentSearchResponse]:
        """Search deployments
    ...
    def _search_deployments_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if deployment_search_request is not None:
            _body_params = deployment_search_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/fabric/v4/deployments/searchDeployments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def search_provider_resources(
        self,
        provider_search_request: ProviderSearchRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param provider_search_request: (required)
        :type provider_search_request: ProviderSearchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._search_provider_resources_serialize(
            provider_search_request=provider_search_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def search_provider_resources_with_http_info(
        self,
        provider_search_request: ProviderSearchRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProviderSearchResponse]:
        """Search provider resources
    ...
    @validate_call
    def search_provider_resources_without_preload_content(
        self,
        provider_search_request: ProviderSearchRequest,
        _request_timeout: Union[
            None,
    ...
    def _search_provider_resources_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if provider_search_request is not None:
            _body_params = provider_search_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/fabric/v4/providerResources/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
