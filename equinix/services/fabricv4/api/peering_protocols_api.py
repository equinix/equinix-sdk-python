...
class PeeringProtocolsApi:
    ...
    def create_connection_peering_protocol(
        ...
        :type uuid: str
        :param connection_peering_protocol_post_request: (required)
        :type connection_peering_protocol_post_request: ConnectionPeeringProtocolPostRequest
        ...
        _param = self._create_connection_peering_protocol_serialize(
            uuid=uuid,
            connection_peering_protocol_post_request=connection_peering_protocol_post_request,
    ...
    def create_connection_peering_protocol_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PeeringProtocolData]:
        """Create Peering Protocol
    ...
    def _create_connection_peering_protocol_serialize(
        self,
        uuid,
        connection_peering_protocol_post_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if connection_peering_protocol_post_request is not None:
            _body_params = connection_peering_protocol_post_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/fabric/v4/connections/{uuid}/peeringProtocols',
