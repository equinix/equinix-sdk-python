...
class ServiceProfilesApi:
    ...
    @validate_call
    def get_service_profile_environments_by_uuid(
        self,
        service_profile_id: Annotated[StrictStr, Field(description="Service Profile UUID")],
        ...
        _param = self._get_service_profile_environments_by_uuid_serialize(
            service_profile_id=service_profile_id,
            offset=offset,
            limit=limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_service_profile_environments_by_uuid_with_http_info(
        self,
        service_profile_id: Annotated[StrictStr, Field(description="Service Profile UUID")],
        offset: Annotated[Optional[StrictInt], Field(description="offset")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="number of records to fetch")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProviderEnvironments]:
        """Get Profile Environments
    ...
    @validate_call
    def get_service_profile_environments_by_uuid_without_preload_content(
        self,
        service_profile_id: Annotated[StrictStr, Field(description="Service Profile UUID")],
        offset: Annotated[Optional[StrictInt], Field(description="offset")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="number of records to fetch")] = None,
    ...
    def _get_service_profile_environments_by_uuid_serialize(
        self,
        service_profile_id,
        offset,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/fabric/v4/serviceProfiles/{serviceProfileId}/environments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def service_profile_environment_action(
        self,
        service_profile_id: Annotated[StrictStr, Field(description="Service Profile UUID")],
        environment_id: Annotated[StrictStr, Field(description="Provider Environment Reference")],
        environment_action_request: EnvironmentActionRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param service_profile_id: Service Profile UUID (required)
        :type service_profile_id: str
        :param environment_id: Provider Environment Reference (required)
        :type environment_id: str
        :param environment_action_request: (required)
        :type environment_action_request: EnvironmentActionRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._service_profile_environment_action_serialize(
            service_profile_id=service_profile_id,
            environment_id=environment_id,
            environment_action_request=environment_action_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def service_profile_environment_action_with_http_info(
        self,
        service_profile_id: Annotated[StrictStr, Field(description="Service Profile UUID")],
        environment_id: Annotated[StrictStr, Field(description="Provider Environment Reference")],
        environment_action_request: EnvironmentActionRequest,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EnvironmentActionResponse]:
        """Service Profile Environment Actions
    ...
    @validate_call
    def service_profile_environment_action_without_preload_content(
        self,
        service_profile_id: Annotated[StrictStr, Field(description="Service Profile UUID")],
        environment_id: Annotated[StrictStr, Field(description="Provider Environment Reference")],
        environment_action_request: EnvironmentActionRequest,
    ...
    def _service_profile_environment_action_serialize(
        self,
        service_profile_id,
        environment_id,
        ...
        # process the form parameters
        # process the body parameter
        if environment_action_request is not None:
            _body_params = environment_action_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/fabric/v4/serviceProfiles/{serviceProfileId}/environments/{environmentId}/actions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_service_profile_by_uuid(
        self,
        service_profile_id: Annotated[StrictStr, Field(description="Service Profile UUID")],
        service_profile_update_operation: List[ServiceProfileUpdateOperation],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param service_profile_id: Service Profile UUID (required)
        :type service_profile_id: str
        :param service_profile_update_operation: (required)
        :type service_profile_update_operation: List[ServiceProfileUpdateOperation]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_service_profile_by_uuid_serialize(
            service_profile_id=service_profile_id,
            service_profile_update_operation=service_profile_update_operation,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_service_profile_by_uuid_serialize(
        self,
        service_profile_id,
        service_profile_update_operation,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if service_profile_update_operation is not None:
            _body_params = service_profile_update_operation
