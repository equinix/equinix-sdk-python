...
class TagsApi:
    ...
    def get_tag_by_uuid(
        self,
        uuid: Annotated[StrictStr, Field(description="UUID of the Tag")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_tag_by_uuid_serialize(
            uuid=uuid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_tag_by_uuid_with_http_info(
        self,
        uuid: Annotated[StrictStr, Field(description="UUID of the Tag")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_tag_by_uuid_without_preload_content(
        self,
        uuid: Annotated[StrictStr, Field(description="UUID of the Tag")],
        _request_timeout: Union[
            None,
    ...
    def _get_tag_by_uuid_serialize(
        self,
        uuid,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/fabric/v4/tags/{uuid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_tags(
        self,
        type: Annotated[Optional[List[StrictStr]], Field(description="Filter by tag type")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Offset for pagination")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True)]], Field(description="Limit for pagination")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
