...
```python
from equinix.services.fabricv4.models.app_service_filter import AppServiceFilter

# TODO update the JSON string below
json = "{}"
# create an instance of AppServiceFilter from a JSON string
app_service_filter_instance = AppServiceFilter.from_json(json)
# print the JSON string representation of the object
print(AppServiceFilter.to_json())

# convert the object into a dict
app_service_filter_dict = app_service_filter_instance.to_dict()
# create an instance of AppServiceFilter from a dict
app_service_filter_from_dict = AppServiceFilter.from_dict(app_service_filter_dict)
```
