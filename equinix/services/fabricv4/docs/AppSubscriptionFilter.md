...
```python
from equinix.services.fabricv4.models.app_subscription_filter import AppSubscriptionFilter

# TODO update the JSON string below
json = "{}"
# create an instance of AppSubscriptionFilter from a JSON string
app_subscription_filter_instance = AppSubscriptionFilter.from_json(json)
# print the JSON string representation of the object
print(AppSubscriptionFilter.to_json())

# convert the object into a dict
app_subscription_filter_dict = app_subscription_filter_instance.to_dict()
# create an instance of AppSubscriptionFilter from a dict
app_subscription_filter_from_dict = AppSubscriptionFilter.from_dict(app_subscription_filter_dict)
```
