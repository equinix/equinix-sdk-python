...
cloud_router_command_search_expression_instance = CloudRouterCommandSearchExpression.from_json(json)
# print the JSON string representation of the object
print(CloudRouterCommandSearchExpression.to_json())

# convert the object into a dict
cloud_router_command_search_expression_dict = cloud_router_command_search_expression_instance.to_dict()
# create an instance of CloudRouterCommandSearchExpression from a dict
cloud_router_command_search_expression_from_dict = CloudRouterCommandSearchExpression.from_dict(cloud_router_command_search_expression_dict)
```
