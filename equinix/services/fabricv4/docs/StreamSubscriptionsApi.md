...
[**search_stream_subscriptions**](StreamSubscriptionsApi.md#search_stream_subscriptions) | **POST** /fabric/v4/streamSubscriptions/search | Search Stream Subscriptions
...
# **search_stream_subscriptions**
> SearchStreamSubscriptionResponse search_stream_subscriptions(stream_subscription_search_request)
...
with equinix.services.fabricv4.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = equinix.services.fabricv4.StreamSubscriptionsApi(api_client)
    stream_subscription_search_request = equinix.services.fabricv4.StreamSubscriptionSearchRequest() # StreamSubscriptionSearchRequest | 

    try:
        # Search Stream Subscriptions
        api_response = api_instance.search_stream_subscriptions(stream_subscription_search_request)
        print("The response of StreamSubscriptionsApi->search_stream_subscriptions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StreamSubscriptionsApi->search_stream_subscriptions: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **stream_subscription_search_request** | [**StreamSubscriptionSearchRequest**](StreamSubscriptionSearchRequest.md)|  | 
