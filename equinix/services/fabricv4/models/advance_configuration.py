...
class AdvanceConfiguration(BaseModel):
    ...
    """ # noqa: E501
    ntp: Optional[List[Md5]] = None
    ptp: Optional[PtpAdvanceConfiguration] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["ntp", "ptp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ntp": [Md5.from_dict(_item) for _item in obj["ntp"]] if obj.get("ntp") is not None else None,
            "ptp": PtpAdvanceConfiguration.from_dict(obj["ptp"]) if obj.get("ptp") is not None else None
        })
