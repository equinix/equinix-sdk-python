...
class AllInterconnectPackagesResponse(BaseModel):
    """
    Interconnect Packages response <font color=\"red\"> <sup color='red'>Beta</sup></font>
    """ # noqa: E501
    pagination: Optional[Pagination] = None
    data: List[InterconnectPackage] = Field(description="List of Interconnect Packages")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [InterconnectPackage.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
