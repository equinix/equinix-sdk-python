...
class AllPortsResponse(BaseModel):
    ...
    data: Optional[List[PortResponse]] = Field(default=None, description="GET All User Port Across Fabric Metros")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [PortResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
