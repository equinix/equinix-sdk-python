...
class AppDomain(BaseModel):
    ...
    name: StrictStr = Field(description="Customer-provided App Domain name")
    ...
    change: Optional[AppDomainChange] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["href", "type", "uuid", "name", "description", "state", "project", "changeLog", "change"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "change": AppDomainChange.from_dict(obj["change"]) if obj.get("change") is not None else None
        })
