...
class AppDomainOrFilter(BaseModel):
    """
    AppDomainOrFilter
    """ # noqa: E501
    var_or: Optional[Annotated[List[AppDomainSimpleExpression], Field(max_length=3)]] = Field(default=None, alias="or")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "or": [AppDomainSimpleExpression.from_dict(_item) for _item in obj["or"]] if obj.get("or") is not None else None
        })
