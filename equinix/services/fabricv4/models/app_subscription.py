...
class AppSubscription(BaseModel):
    ...
    source: AppSubscriptionSource
    target: AppSubscriptionTarget
    state: Optional[AppSubscriptionState] = None
    project: Project
    change_log: Optional[Changelog] = Field(default=None, alias="changeLog")
    change: Optional[AppSubscriptionChange] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["href", "type", "uuid", "source", "target", "state", "project", "changeLog", "change"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "uuid": obj.get("uuid"),
            "source": AppSubscriptionSource.from_dict(obj["source"]) if obj.get("source") is not None else None,
            "target": AppSubscriptionTarget.from_dict(obj["target"]) if obj.get("target") is not None else None,
            "state": obj.get("state"),
            "project": Project.from_dict(obj["project"]) if obj.get("project") is not None else None,
            "changeLog": Changelog.from_dict(obj["changeLog"]) if obj.get("changeLog") is not None else None,
            "change": AppSubscriptionChange.from_dict(obj["change"]) if obj.get("change") is not None else None
        })
