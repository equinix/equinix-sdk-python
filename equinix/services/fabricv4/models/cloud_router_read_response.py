...
class CloudRouterReadResponse(BaseModel):
    """
    Fabric Cloud Router read response object
    """ # noqa: E501
    type: Optional[CloudRouterReadResponseType] = None
    ...
    __properties: ClassVar[List[str]] = ["type", "name", "location", "package", "order", "project", "account", "notifications", "href", "uuid", "state", "equinixAsn", "connectionsCount", "marketplaceSubscription", "changeLog", "change"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "change": CloudRouterChange.from_dict(obj["change"]) if obj.get("change") is not None else None
        })
