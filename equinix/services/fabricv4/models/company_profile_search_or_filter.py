...
class CompanyProfileSearchOrFilter(BaseModel):
    """
    Groups multiple simple expressions with OR logic. At most one `or` group is allowed within the top-level `and` array. 
    """ # noqa: E501
    var_or: Annotated[List[CompanyProfileSearchSimpleExpression], Field(min_length=1)] = Field(alias="or")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "or": [CompanyProfileSearchSimpleExpression.from_dict(_item) for _item in obj["or"]] if obj.get("or") is not None else None
        })
