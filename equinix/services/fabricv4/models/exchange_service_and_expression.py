...
class ExchangeServiceAndExpression(BaseModel):
    """
    ExchangeServiceAndExpression
    """ # noqa: E501
    var_and: List[ExchangeServiceSearchExpression] = Field(alias="and")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "and": [ExchangeServiceSearchExpression.from_dict(_item) for _item in obj["and"]] if obj.get("and") is not None else None
        })
...
ExchangeServiceAndExpression.model_rebuild(raise_errors=False)
