...
class ExchangeServiceOrExpression(BaseModel):
    """
    ExchangeServiceOrExpression
    """ # noqa: E501
    var_or: List[ExchangeServiceSearchExpression] = Field(alias="or")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "or": [ExchangeServiceSearchExpression.from_dict(_item) for _item in obj["or"]] if obj.get("or") is not None else None
        })
...
ExchangeServiceOrExpression.model_rebuild(raise_errors=False)
