...
class ExchangeServiceSearchRequest(BaseModel):
    """
    Search requests containing criteria
    """ # noqa: E501
    filter: Optional[ExchangeServiceSearchExpression] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": ExchangeServiceSearchExpression.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
