...
class ExchangeServiceSearchResponse(BaseModel):
    """
    List of Internet Exchange Service
    """ # noqa: E501
    pagination: Optional[Pagination] = None
    sort: Optional[List[ExchangeServiceSearchSortCriteria]] = None
    data: Optional[List[ExchangeServiceResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": [ExchangeServiceSearchSortCriteria.from_dict(_item) for _item in obj["sort"]] if obj.get("sort") is not None else None,
            "data": [ExchangeServiceResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
