...
class FabricRoutingProtocolBGPType(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "name", "uuid", "bgpIpv4", "customerAsn", "bgpAuthKey", "asOverrideEnabled", "deploymentProperties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "uuid": obj.get("uuid"),
            "bgpIpv4": FabricBGPConnectionIpv4.from_dict(obj["bgpIpv4"]) if obj.get("bgpIpv4") is not None else None,
