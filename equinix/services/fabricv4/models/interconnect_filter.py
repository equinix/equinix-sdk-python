...
class InterconnectFilter(BaseModel):
    """
    InterconnectFilter
    """ # noqa: E501
    var_and: Optional[List[InterconnectFilter]] = Field(default=None, alias="and")
    var_or: Optional[List[InterconnectFilter]] = Field(default=None, alias="or")
    var_property: Optional[InterconnectSearchFieldName] = Field(default=None, alias="property")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "and": [InterconnectFilter.from_dict(_item) for _item in obj["and"]] if obj.get("and") is not None else None,
            "or": [InterconnectFilter.from_dict(_item) for _item in obj["or"]] if obj.get("or") is not None else None,
...
InterconnectFilter.model_rebuild(raise_errors=False)
