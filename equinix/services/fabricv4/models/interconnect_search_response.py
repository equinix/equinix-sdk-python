...
class InterconnectSearchResponse(BaseModel):
    """
    List of interconnects
    """ # noqa: E501
    pagination: Optional[Pagination] = None
    sort: Optional[List[InterconnectSortCriteriaResponse]] = None
    data: Optional[List[Interconnect]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": [InterconnectSortCriteriaResponse.from_dict(_item) for _item in obj["sort"]] if obj.get("sort") is not None else None,
            "data": [Interconnect.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
