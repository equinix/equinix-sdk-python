...
class InternetAccessAccount(BaseModel):
    """
    InternetAccessAccount
    """ # noqa: E501
    account_number: StrictStr = Field(description="Account number", alias="accountNumber")
    href: Optional[StrictStr] = Field(default=None, description="Account URL path")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accountNumber", "href"]
