...
class InternetAccessCustomerRoute(BaseModel):
    """
    InternetAccessCustomerRoute
    """ # noqa: E501
    ip_block: Optional[InternetAccessIpBlock] = Field(default=None, alias="ipBlock")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["ipBlock"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ipBlock": InternetAccessIpBlock.from_dict(obj["ipBlock"]) if obj.get("ipBlock") is not None else None
        })
