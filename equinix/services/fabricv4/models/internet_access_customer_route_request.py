...
class InternetAccessCustomerRouteRequest(BaseModel):
    """
    InternetAccessCustomerRouteRequest
    """ # noqa: E501
    ip_block: InternetAccessIpBlockRequest = Field(alias="ipBlock")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ipBlock": InternetAccessIpBlockRequest.from_dict(obj["ipBlock"]) if obj.get("ipBlock") is not None else None
        })
