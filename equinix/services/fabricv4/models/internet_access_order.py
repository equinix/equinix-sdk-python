...
class InternetAccessOrder(BaseModel):
    """
    InternetAccessOrder
    """ # noqa: E501
    ...
    href: Optional[StrictStr] = Field(default=None, description="Order URI")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["purchaseOrderNumber", "customerReferenceNumber", "billingTier", "orderId", "orderNumber", "termLength", "contractedBandwidth", "href"]
