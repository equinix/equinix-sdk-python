...
class InternetAccessOrderRequest(BaseModel):
    """
    ...
    order_line: Optional[StrictStr] = Field(default=None, description="Order Line Number", alias="orderLine")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["purchaseOrderNumber", "orderNumber", "orderLine"]
