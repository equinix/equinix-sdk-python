...
class InternetAccessRoutingProtocolDirectRequest(InternetAccessRoutingProtocolRequest):
    """
    InternetAccessRoutingProtocolDirectRequest
    """ # noqa: E501
    connections: Annotated[List[InternetAccessConnectionDirectRequest], Field(min_length=1, max_length=2)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connections": [InternetAccessConnectionDirectRequest.from_dict(_item) for _item in obj["connections"]] if obj.get("connections") is not None else None
        })
