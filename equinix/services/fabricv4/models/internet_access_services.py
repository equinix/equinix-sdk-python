...
class InternetAccessServices(BaseModel):
    """
    InternetAccessServices
    """ # noqa: E501
    pagination: Pagination
    sort: List[SearchSortItem]
    data: List[InternetAccessService]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [InternetAccessService.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
