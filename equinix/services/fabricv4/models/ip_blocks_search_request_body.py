...
class IpBlocksSearchRequestBody(BaseModel):
    """
    IpBlocksSearchRequestBody
    """ # noqa: E501
    pagination: Optional[PaginationRequest] = None
    filter: Optional[IpBlockFilter] = None
    sort: Optional[List[SearchSortItem]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["pagination", "filter", "sort"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filter": IpBlockFilter.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "sort": [SearchSortItem.from_dict(_item) for _item in obj["sort"]] if obj.get("sort") is not None else None
        })
