...
class LoaActionSearchRequest(BaseModel):
    """
    Search loa actions based on filter criteria
    """ # noqa: E501
    filter: Optional[LoaActionSearchFilters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": LoaActionSearchFilters.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
