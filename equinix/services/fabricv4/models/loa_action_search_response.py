...
class LoaActionSearchResponse(BaseModel):
    """
    List of LOA Actions
    """ # noqa: E501
    pagination: Optional[Pagination] = None
    sort: Optional[List[LoaActionSortCriteria]] = None
    data: Optional[List[LoaActionResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": [LoaActionSortCriteria.from_dict(_item) for _item in obj["sort"]] if obj.get("sort") is not None else None,
            "data": [LoaActionResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
