...
class LoaConsumersResponse(BaseModel):
    """
    List of Consumers associated with a LOA
    """ # noqa: E501
    pagination: Optional[Pagination] = None
    data: Optional[List[LoaConsumer]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [LoaConsumer.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
