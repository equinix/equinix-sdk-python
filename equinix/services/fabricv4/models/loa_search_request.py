...
class LoaSearchRequest(BaseModel):
    """
    Search loas based on filter criteria
    """ # noqa: E501
    filter: Optional[LoaSearchFilters] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": LoaSearchFilters.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
