...
class LoaSearchResponse(BaseModel):
    """
    List of LOAs
    """ # noqa: E501
    pagination: Optional[Pagination] = None
    sort: Optional[List[LoaSortCriteria]] = None
    data: Optional[List[LoaResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": [LoaSortCriteria.from_dict(_item) for _item in obj["sort"]] if obj.get("sort") is not None else None,
            "data": [LoaResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
