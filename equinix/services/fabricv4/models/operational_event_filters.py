...
class OperationalEventFilters(BaseModel):
    """
    OperationalEventFilters
    """ # noqa: E501
    var_and: Optional[List[OperationalEventSimpleExpression]] = Field(default=None, alias="and")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "and": [OperationalEventSimpleExpression.from_dict(_item) for _item in obj["and"]] if obj.get("and") is not None else None
        })
