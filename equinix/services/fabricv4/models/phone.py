...
class Phone(BaseModel):
    ...
    number: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Phone number")
    contact_preference: Optional[ContactPreference] = Field(default=None, alias="contactPreference")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "number", "contactPreference"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contactPreference": ContactPreference.from_dict(obj["contactPreference"]) if obj.get("contactPreference") is not None else None
        })
