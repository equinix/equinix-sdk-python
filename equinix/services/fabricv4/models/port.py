...
class Port(BaseModel):
    ...
    physical_ports_type: PortResponsePhysicalPortsType = Field(alias="physicalPortsType")
    physical_ports_count: Optional[StrictInt] = Field(default=None, alias="physicalPortsCount")
    connectivity_source_type: PortResponseConnectivitySourceType = Field(alias="connectivitySourceType")
    ...
    account: SimplifiedAccountPortResponse
