...
from equinix.services.fabricv4.models.port_response_bmmr_type import PortResponseBmmrType
from equinix.services.fabricv4.models.port_response_connectivity_source_type import PortResponseConnectivitySourceType
from equinix.services.fabricv4.models.port_response_physical_ports_type import PortResponsePhysicalPortsType
from equinix.services.fabricv4.models.port_response_service_type import PortResponseServiceType
...
class PortResponse(BaseModel):
    ...
    physical_ports_type: Optional[PortResponsePhysicalPortsType] = Field(default=None, alias="physicalPortsType")
    physical_ports_count: Optional[StrictInt] = Field(default=None, alias="physicalPortsCount")
    connectivity_source_type: Optional[PortResponseConnectivitySourceType] = Field(default=None, alias="connectivitySourceType")
    bmmr_type: Optional[PortResponseBmmrType] = Field(default=None, alias="bmmrType")
    project: Optional[Project] = None
    state: Optional[PortState] = None
    order: Optional[PortOrder] = None
    cvp_id: Optional[StrictStr] = Field(default=None, description="Equinix assigned response attribute for Unique ID for a virtual port.", alias="cvpId")
    operation: Optional[PortOperation] = None
    account: Optional[SimplifiedAccountPortResponse] = None
    changelog: Optional[Changelog] = None
    service_type: Optional[PortResponseServiceType] = Field(default=None, alias="serviceType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "account": SimplifiedAccountPortResponse.from_dict(obj["account"]) if obj.get("account") is not None else None,
