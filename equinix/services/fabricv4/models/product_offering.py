...
class ProductOffering(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Product offering identifier")
    name: Optional[StrictStr] = Field(default=None, description="Product offering name")
