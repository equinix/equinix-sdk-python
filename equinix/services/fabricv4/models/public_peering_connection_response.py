...
class PublicPeeringConnectionResponse(BaseModel):
    """
    PublicPeeringConnectionResponse
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Connection type IX_VC")
    href: Optional[StrictStr] = Field(default=None, description="URI")
    uuid: Optional[StrictStr] = Field(default=None, description="uuid")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "href", "uuid"]
