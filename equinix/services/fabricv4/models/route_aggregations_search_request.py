...
class RouteAggregationsSearchRequest(BaseModel):
    """
    Search route aggregations
    """ # noqa: E501
    filter: Optional[SearchFilter] = None
    pagination: Optional[PaginationRequest] = None
    sort: Optional[List[RouteAggregationSortCriteria]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": [RouteAggregationSortCriteria.from_dict(_item) for _item in obj["sort"]] if obj.get("sort") is not None else None
        })
