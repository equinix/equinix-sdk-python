...
class RouteFiltersSearchRequest(BaseModel):
    """
    Search route filters
    """ # noqa: E501
    filter: Optional[SearchFilter] = None
    pagination: Optional[PaginationRequest] = None
    sort: Optional[List[RouteFilterSortCriteria]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": [RouteFilterSortCriteria.from_dict(_item) for _item in obj["sort"]] if obj.get("sort") is not None else None
        })
