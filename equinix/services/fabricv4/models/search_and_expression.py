...
class SearchAndExpression(BaseModel):
    """
    SearchAndExpression
    """ # noqa: E501
    var_and: Annotated[List[SearchFilterExpression], Field(min_length=1, max_length=8)] = Field(alias="and")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "and": [SearchFilterExpression.from_dict(_item) for _item in obj["and"]] if obj.get("and") is not None else None
        })
...
SearchAndExpression.model_rebuild(raise_errors=False)
