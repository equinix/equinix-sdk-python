...
class SearchOrExpression(BaseModel):
    """
    SearchOrExpression
    """ # noqa: E501
    var_or: Annotated[List[SearchFilterExpression], Field(min_length=1, max_length=8)] = Field(alias="or")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "or": [SearchFilterExpression.from_dict(_item) for _item in obj["or"]] if obj.get("or") is not None else None
        })
...
SearchOrExpression.model_rebuild(raise_errors=False)
