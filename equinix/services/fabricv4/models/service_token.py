...
class ServiceToken(BaseModel):
    ...
    uuid: StrictStr = Field(description="Equinix-assigned service token identifier")
    ...
    __properties: ClassVar[List[str]] = ["type", "href", "uuid", "name", "description", "expirationDateTime", "connection", "state", "notifications", "account", "changelog", "project"]
