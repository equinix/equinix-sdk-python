...
class Sort(BaseModel):
    ...
    Sort
    """ # noqa: E501
    var_property: Optional[StrictStr] = Field(default=None, description="Property to sort by. Supported values:  * `/name` - Company profile name  * `/state` - Company profile state  * `/changeLog/updatedDateTime` - Date and time the profile was last updated  * `/changeLog/createdDateTime` - Date and time the profile was created ", alias="property")
