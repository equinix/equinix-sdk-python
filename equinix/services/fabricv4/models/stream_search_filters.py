...
class StreamSearchFilters(BaseModel):
    ...
    StreamSearchFilters
    """ # noqa: E501
    var_and: Annotated[List[StreamSearchFilter], Field(min_length=1, max_length=10)] = Field(alias="and")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "and": [StreamSearchFilter.from_dict(_item) for _item in obj["and"]] if obj.get("and") is not None else None
        })
