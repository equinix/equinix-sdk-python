...
class StreamSubscriptionSearchOrFilter(BaseModel):
    """
    StreamSubscriptionSearchOrFilter
    """ # noqa: E501
    var_or: Optional[List[StreamSubscriptionSearchSimpleExpression]] = Field(default=None, alias="or")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "or": [StreamSubscriptionSearchSimpleExpression.from_dict(_item) for _item in obj["or"]] if obj.get("or") is not None else None
        })
