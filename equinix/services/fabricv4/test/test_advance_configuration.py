...
class TestAdvanceConfiguration(unittest.TestCase):
    """AdvanceConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdvanceConfiguration:
        """Test AdvanceConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdvanceConfiguration`
        """
        model = AdvanceConfiguration()
        if include_optional:
    ...
    def testAdvanceConfiguration(self):
        """Test AdvanceConfiguration"""
