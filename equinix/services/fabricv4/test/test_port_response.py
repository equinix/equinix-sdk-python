...
class TestPortResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PortResponse:
        """Test PortResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortResponse`
        """
        model = PortResponse()
        if include_optional:
            return PortResponse(
                ...
                account = equinix.services.fabricv4.models.simplified_account_port_response.SimplifiedAccountPortResponse(
                    account_number = '', 
                    org_id = '', 
