...
class BatchesApi:
    ...
    def create_device_batch(
        ...
        _param = self._create_device_batch_serialize(
            id=id,
            instances_batch_create_input=instances_batch_create_input,
    ...
    def _create_device_batch_serialize(
        self,
        id,
        ...
        if instances_batch_create_input is not None:
            _body_params = instances_batch_create_input
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/projects/{id}/devices/batch',
    ...
    def _delete_batch_serialize(
        ...
        if id is not None:
            _path_params['id'] = id
        # process the query parameters
        if remove_associated_instances is not None:
            
            _query_params.append(('remove_associated_instances', remove_associated_instances))
    ...
    def find_batch_by_id(
        ...
        _param = self._find_batch_by_id_serialize(
            id=id,
            include=include,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _find_batch_by_id_serialize(
        self,
        id,
        include,
        _request_auth,
    ...
    def find_batches_by_project(
        ...
        _param = self._find_batches_by_project_serialize(
            id=id,
            include=include,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _find_batches_by_project_serialize(
        self,
        id,
        include,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/projects/{id}/batches',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
