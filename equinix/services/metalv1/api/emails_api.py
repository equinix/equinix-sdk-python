...
class EmailsApi:
    ...
    def create_email(
        self,
        create_email_input: Annotated[CreateEmailInput, Field(description="Email to create")],
        ...
        """(Deprecated) Create an email

        Add a new email address to the current user.

        :param create_email_input: Email to create (required)
        :type create_email_input: CreateEmailInput
        ...
        """ # noqa: E501
        warnings.warn("POST /emails is deprecated.", DeprecationWarning)

        _param = self._create_email_serialize(
            create_email_input=create_email_input,
    ...
    def _create_email_serialize(
        ...
        if create_email_input is not None:
            _body_params = create_email_input
    ...
    def find_email_by_id(
        ...
        _param = self._find_email_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _find_email_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def update_email(
        ...
        :param id: Email UUID (required)
        :type id: str
        :param update_email_input: email to update (required)
        :type update_email_input: UpdateEmailInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _update_email_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_email_input is not None:
            _body_params = update_email_input
