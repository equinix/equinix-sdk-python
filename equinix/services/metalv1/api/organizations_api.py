...
class OrganizationsApi:
    ...
    def get_organization_members(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization UUID")],
        include: Annotated[Optional[List[StrictStr]], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param organization_id: Organization UUID (required)
    ...
    def remove_organization_member(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization UUID")],
        id: Annotated[StrictStr, Field(description="Member UUID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _remove_organization_member_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/organizations/{organization_id}/members/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def update_organization_member_roles(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization UUID")],
        id: Annotated[StrictStr, Field(description="Member UUID")],
        member_update_input: Annotated[Optional[MemberUpdateInput], Field(description="Organization to update")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Member UUID (required)
        :type id: str
        :param member_update_input: Organization to update
        :type member_update_input: MemberUpdateInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_organization_member_roles_serialize(
            organization_id=organization_id,
            id=id,
            member_update_input=member_update_input,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_organization_member_roles_with_http_info(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization UUID")],
        id: Annotated[StrictStr, Field(description="Member UUID")],
        member_update_input: Annotated[Optional[MemberUpdateInput], Field(description="Organization to update")] = None,
    ...
    @validate_call
    def update_organization_member_roles_without_preload_content(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization UUID")],
        id: Annotated[StrictStr, Field(description="Member UUID")],
        member_update_input: Annotated[Optional[MemberUpdateInput], Field(description="Organization to update")] = None,
    ...
    def _update_organization_member_roles_serialize(
        self,
        organization_id,
        id,
        member_update_input,
        ...
        # process the form parameters
        # process the body parameter
        if member_update_input is not None:
            _body_params = member_update_input
