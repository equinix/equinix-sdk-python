...
class SelfServiceReservationsApi:
    ...
    def create_self_service_reservation(
        ...
        _param = self._create_self_service_reservation_serialize(
            ...
            create_self_service_reservation_request=create_self_service_reservation_request,
    ...
    def _create_self_service_reservation_serialize(
        ...
        if create_self_service_reservation_request is not None:
            _body_params = create_self_service_reservation_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/projects/{project_id}/self-service/reservations',
    ...
    def find_self_service_reservation(
        ...
        _param = self._find_self_service_reservation_serialize(
            id=id,
            project_id=project_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _find_self_service_reservation_serialize(
        self,
        id,
        project_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/projects/{project_id}/self-service/reservations/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def find_self_service_reservations(
        ...
        _param = self._find_self_service_reservations_serialize(
            project_id=project_id,
            page=page,
            per_page=per_page,
    ...
    def find_self_service_reservations_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SelfServiceReservationList]:
        """Retrieve all reservations
    ...
    def _find_self_service_reservations_serialize(
        self,
        project_id,
        page,
        per_page,
