...
class SSHKeysApi:
    ...
    def create_project_ssh_key(
        ...
        _param = self._create_project_ssh_key_serialize(
            id=id,
            ssh_key_create_input=ssh_key_create_input,
            include=include,
    ...
    def _create_project_ssh_key_serialize(
        self,
        id,
        ...
        if ssh_key_create_input is not None:
            _body_params = ssh_key_create_input
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/projects/{id}/ssh-keys',
    ...
    def find_device_ssh_keys(
        ...
        _param = self._find_device_ssh_keys_serialize(
            id=id,
    ...
    def _find_device_ssh_keys_serialize(
        self,
        id,
        search_string,
        include,
        ...
        if search_string is not None:
            ...
            _query_params.append(('Search string', search_string))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/devices/{id}/ssh-keys',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def find_project_ssh_keys(
        ...
        _param = self._find_project_ssh_keys_serialize(
            id=id,
            query=query,
            include=include,
            _request_auth=_request_auth,
    ...
    def _find_project_ssh_keys_serialize(
        self,
        id,
        query,
        include,
    ...
    def find_ssh_key_by_id(
        ...
        _param = self._find_ssh_key_by_id_serialize(
            id=id,
            include=include,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _find_ssh_key_by_id_serialize(
        self,
        id,
        include,
        _request_auth,
    ...
    def find_ssh_keys(
        self,
        search: Annotated[Optional[StrictStr], Field(description="Search by key, label, or fingerprint")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._find_ssh_keys_serialize(
            search=search,
            include=include,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def find_ssh_keys_without_preload_content(
        self,
        search: Annotated[Optional[StrictStr], Field(description="Search by key, label, or fingerprint")] = None,
        include: Annotated[Optional[List[StrictStr]], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None,
        _request_timeout: Union[
    ...
    def update_ssh_key(
        ...
        _param = self._update_ssh_key_serialize(
            id=id,
