...
class SupportRequestApi:
    ...
    def request_support(
        ...
        :param support_request_input: Support Request to create (required)
        :type support_request_input: SupportRequestInput
    ...
    def _request_support_serialize(
        ...
        if support_request_input is not None:
            _body_params = support_request_input
