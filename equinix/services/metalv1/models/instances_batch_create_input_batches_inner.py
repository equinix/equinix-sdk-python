...
class InstancesBatchCreateInputBatchesInner(BaseModel):
    ...
    ipxe_script_url: Optional[StrictStr] = Field(default=None, description="When set, the device will chainload an iPXE Script at boot fetched from the supplied URL.  See [Custom iPXE](https://docs.equinix.com/metal/operating-systems/custom-ipxe/) for more details.")
    ...
    spot_instance: Optional[StrictBool] = Field(default=None, description="DEPRECATED. Spot Market has been discontinued.")
    spot_price_max: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="DEPRECATED. Spot Market has been discontinued.")
    ...
    userdata: Optional[StrictStr] = Field(default=None, description="The userdata presented in the metadata service for this device.  Userdata is fetched and interpreted by the operating system installed on the device. Acceptable formats are determined by the operating system, with the exception of a special iPXE enabling syntax which is handled before the operating system starts.  See [Server User Data](https://docs.equinix.com/metal/server-metadata/user-data/) and [Provisioning with Custom iPXE](https://docs.equinix.com/metal/operating-systems/custom-ipxe/#provisioning-with-custom-ipxe) for more details.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "href": obj.get("href"),
            "metro": MetroInputMetro.from_dict(obj["metro"]) if obj.get("metro") is not None else None,
