...
class TestEventList1(unittest.TestCase):
    """EventList1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventList1:
        """Test EventList1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventList1`
        """
        model = EventList1()
        if include_optional:
            return EventList1(
