...
class TestPlanList1(unittest.TestCase):
    """PlanList1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlanList1:
        """Test PlanList1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlanList1`
        """
        model = PlanList1()
        if include_optional:
            return PlanList1(
